    ...
    return (
        <Drawer variant="permanent" open={open} PaperProps={{sx: {backgroundColor: drawerColor}}}>
            ...
            <List sx={{flexGrow: 1}}>
                ...
                <ListItem sx={{minHeight: 64, justifyContent: open ? "initial" : "center", px: 2.5,}}
                          key={"/api-tests"} component={Link} to={"/api-tests"} selected={selectedIndex === 3}>
                    <ListItemIcon sx={{minWidth: 0, mr: open ? 2 : "auto", justifyContent: "center",}}>
                ...
                <ListItem sx={{minHeight: 64, justifyContent: open ? "initial" : "center", px: 2.5,}}
                          key={"/reports"} component={Link} to={"/reports"} selected={selectedIndex === 4}>
                    <ListItemIcon sx={{minWidth: 0, mr: open ? 2 : "auto", justifyContent: "center",}}>
                ...
                <ListItem sx={{minHeight: 64, justifyContent: open ? "initial" : "center", px: 2.5,}}
                          key={"/import"} component={Link} to={"/import"} selected={selectedIndex === 5}>
                    <ListItemIcon sx={{minWidth: 0, mr: open ? 2 : "auto", justifyContent: "center",}}>
